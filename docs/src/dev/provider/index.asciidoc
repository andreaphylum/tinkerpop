...
// TODO: UPDATE rs = aliased.submit(g.V().both().barrier().both().barrier()).all().get()                    <2>
// TODO: UPDATE aliased.submit(g.V().both().barrier().both().barrier().count()).all().get().get(0).getInt() <3>
